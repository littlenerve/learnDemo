...
public class ComparatorTest {
    ...
    public static void main(String[] args) {
        ...
        list.stream().sorted(Comparator.comparingInt(Person::getHeight).reversed()).sorted(Comparator.comparingInt(Person::getAge).reversed());
        System.out.println(list);
        ...
        System.out.println(list);
        list.stream().sorted(Comparator.comparingInt(Person::getHeight)).sorted(Comparator.comparingInt(Person::getAge));
        System.out.println(list);
